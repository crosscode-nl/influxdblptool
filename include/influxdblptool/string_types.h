...
namespace influxdblptool {
    ...
    using tag_key = traits::validated_serializable_string<validators::throw_when_tag_key_invalid,escapers::escape_tag_key>;
    using tag_value = traits::validated_serializable_string<validators::throw_when_tag_value_invalid,escapers::escape_tag_value>;
    using field_key = traits::validated_serializable_string<validators::throw_when_field_key_invalid,escapers::escape_field_key>;
    using field_string_value = traits::validated_serializable_string<validators::throw_when_field_string_value_invalid,escapers::escape_field_string_value>;
    using measurement = traits::validated_serializable_string<validators::throw_when_measurement_invalid,escapers::escape_measurement>;
