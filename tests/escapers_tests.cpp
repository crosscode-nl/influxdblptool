...
TEST_SUITE("escapers") {
    ...
    {
        CHECK_EQ(11,escape_tag_key_count(", \"\\=abc"s));
    }
    ...
    {
        CHECK_EQ(11,escape_tag_value_count(", \"\\=abc"s));
    }
    ...
    {
        CHECK_EQ(11,escape_field_key_count(", \"\\=abc"s));
    }
    ...
    {
        CHECK_EQ(10,escape_field_string_value_count(", \"\\=abc"s));
    }
}
