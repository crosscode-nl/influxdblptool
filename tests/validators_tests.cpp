    ...
    TEST_CASE("throw_when_tag_value_invalid")
    {
        ...
        SUBCASE("valid input") {
            SUBCASE("string case insensitive compares to time does not throw") {
                REQUIRE_NOTHROW(fut("tImE"));
            }
            SUBCASE("_ at start of string does not throw") {
                REQUIRE_NOTHROW(fut("_something"));
            }
